...
#line hidden
        ...
        public UserLoginFeature(UserLoginFeature.FixtureData fixtureData, EstateAdministrationUI_IntegrationTests_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Login As Estate Administrator")]
        [Xunit.TraitAttribute("FeatureTitle", "UserLogin")]
        [Xunit.TraitAttribute("Description", "Login As Estate Administrator")]
        [Xunit.TraitAttribute("Category", "PRTest")]
        public virtual void LoginAsEstateAdministrator()
        {
            string[] tagsOfScenario = new string[] {
                    "PRTest"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Login As Estate Administrator", null, new string[] {
                        "PRTest"});
#line 23
